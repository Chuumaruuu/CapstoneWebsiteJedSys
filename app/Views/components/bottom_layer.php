    <footer class="footer bg-dark d-flex flex-wrap justify-content-between align-items-center mt-auto py-3 px-3" data-bs-theme="dark">
        <p class="col-md-4 mb-0 text-body-secondary fs-4">© 2025 Jed's System Analysis and Design</p>
